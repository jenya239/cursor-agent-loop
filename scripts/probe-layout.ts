...
import { CURSOR_LAYOUT_PROBE_JS } from '../src/cdp/probes/cursor-layout.v1';
    ...
    try {
      ...
      try {
        ...
        const r = (await send('Runtime.evaluate', {
          expression: CURSOR_LAYOUT_PROBE_JS,
          returnByValue: true,
        })) as { result?: { value?: unknown } };
        console.log(JSON.stringify({ window: page.title, layout: r.result?.value }, null, 2));
      } finally {
        close();
      }
    } catch (e) {
